...
Ext.define('OA.model.wk.Notes', {
    ...
    config: {
        fields: [
            ...
            //Layout Config
            {
                ...
                return [
                    ...
                    // },
                    {
                        ...
                        return {x: OA.common.DIMgr.getPageMargin().left, feature: 'draftNote', size: 14};
                        }
                    },
                    {
                    ...
                    },
                    {
                        key: '機關', getPos: function () {
                            return {
                                x: OA.common.DIMgr.getPageWidth() * 0.21,
                                size: 18,
                                y: OA.common.DIMgr.getPageMargin().top * 1.5,
                    ...
                    },
                    {
                        key: '密等及解密條件或保密期限', getPos: function () {
                            return { x: OA.common.DIMgr.getPageMargin().left, feature: 'follow_align_block', size: 18 };
                        }
                    },
                    // {
                    ...
                    // },
                    {
                     ...
                     {
                         key: '敬陳', wk: false, getPos: function () {
                         return {
                             x: OA.common.DIMgr.getPageMargin().left,
                             size: 21,
                             interval: '2%',
                    ...
                    {
                        key: '核示', wk: false, getPos: function () {
                            return {
                                x: OA.common.DIMgr.getPageMargin().left + 65,
                                size: 22,
                                interval: '2%',
            ...
            {
                name: '核示', mapping: function (node) {
                    return { items: OA.common.Utils.getWKChildren(node, '核示') };
                }
            },
            // {
            //     name: '副總經理', mapping: function (node) {
            //         return '副總經理';
            //     }
            // },
            // {
            //     name: '總經理', mapping: function (node) {
            //         return '總經理';
            //     }
            // },
            // {
            //     name: '董事長', mapping: function (node) {
            //         return '董事長';
            //     }
            // },
            {
