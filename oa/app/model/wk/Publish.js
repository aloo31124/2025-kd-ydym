...
Ext.define('OA.model.wk.Publish', {
                    ...
                    return [
                        {
                            key: '稿面註記', wk: true, getPos: function () {
                                return { y: OA.common.DIMgr.getPageMargin().top - 50, feature: 'draftNote', size: 14 };
                            }
                        },
                        {
                        ...
                        },
                        {
                            key: '發文日期', getPos: function () {
                                return { x: OA.common.DIMgr.getPageMargin().left, interval: '8%', feature: 'follow_align_block', size: 16 };
                            }
                        },
                        {
                        ...
                        },
                        {
                            key: 'KDRichTextBlock', getPos: function () {
                                return {
                                    x: OA.common.DIMgr.getPageMargin().left, interval: '16%', size: 22,
                                    feature: 'paragraph_block'
                                };
                            }
                        },
                        {
                            key: '署名', wk: true, getPos: function () {
                                return { size: 27 };
                            }
                        },
                        {
