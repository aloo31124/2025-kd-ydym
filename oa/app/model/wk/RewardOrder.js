...
Ext.define('OA.model.wk.RewardOrder', {
    ...
    config: {
        fields: [
                    ...
                    return [
                        ...
                        },
                        {
                            key: '承辦單位', wk: true, getPos: function () {
                                return { x: OA.common.DIMgr.getPageMargin().left, interval: '1%', feature: 'follow_align_block', size: 15 };
                            }
                        },
                        {
                        ...
                        },
                        {
                            key: '應用限制', wk: true, getPos: function () {
                                return { feature: 'todoWay', size: 15 };
                            }
                        },
                        {
                        ...
                        },
                        {
                            key: '附件', getPos: function () {
                                return { x: OA.common.DIMgr.getPageMargin().left, feature: 'follow_caption_block' };
                            }
                        },
...

                        {
                            key: 'KDRichTextBlock', getPos: function () {
                                return {
                                    x: OA.common.DIMgr.getPageMargin().left, interval: '3%', size: 22,
                        ...
                        {
                            key: '迴避要點', wk: true, getPos: function ()  {
                                return { size: 24, feature: 'avoid_align_block', interval: '2%' }
                            }
                        },
                        //    {
            ...
            {
                name: '迴避要點', mapping: function (node) {
                    return '＊本案主辦及會辦單位之各級人員，如依法令或本中心　內部規章有應行迴避之情事者，應自行迴避。'
                }
            },
            {
