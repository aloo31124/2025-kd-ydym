...
Ext.define('OA.model.wk.Meeting', {
    ...
    config: {
        fields: [
                ...
                return [
                    ...
                    },
                    {
                        key: '出席者', getPos: function () {
                            return { x: OA.common.DIMgr.getPageMargin().left, interval: '1%', feature: 'follow_caption_block', size: 16};
                    }
                    },
                    {
            ...
            {
                name: '開會事由', mapping: function (node) {
                return {items: OA.common.Utils.getWKChildren(node, '開會事由')};
            }
            },
            {
