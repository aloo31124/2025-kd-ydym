...
Ext.define('OA.model.wk.SealContinuationSheet', {
        ...
        fields: [
            ...
            //表格模版
            {
                name: 'templateUrl', mapping: function () {
                    return 'web/SealContinuationSheet.svg';
                }
            },
            ...
            },
            {
                name: '發文日期', mapping: function (node) {
                    return { items: OA.common.Utils.getWKChildren(node, '發文日期') };
                }
            },
            {
                name: '會銜發文字號', mapping: function (node) {
                    return { items: OA.common.Utils.getWKChildren(node, '會銜發文字號') };
                }
            },
            {
                name: '會銜主旨', mapping: function (node) {
                    return { items: OA.common.Utils.getWKChildren(node, '會銜主旨') };
                }
            },
            {
