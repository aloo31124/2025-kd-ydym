...
Ext.define('OA.model.wk.Other', {
    ...
    config: {
        fields: [
            ...
            'orgNo', 'orgId', 'genDocNo', 'version', 'paperNo', 'kind',
                ...
                return [
                    ...
                    },
                    {
                        ...
                        return {
                            ...
                            x: OA.common.DIMgr.getPageWidth() * 0.5,
                            interval: '2.6%',
                    ...
                    },
                    {
                        key: '受文者郵遞區號', wk: true, getPos: function () {
                            return { x: OA.common.DIMgr.getPageMargin().left, interval: '-5%', size: 16 }
                    }
                    },
                    {
