...
Ext.define('OA.model.wk.DraftVerify', {
    ...
    config: {
        fields: [
            ...
            {
                name: '案情摘要', mapping: function (node) {
                return {items: OA.common.Utils.getWKChildren(node, '案情摘要')};
            }
            },
            {
            ...
            {
                name: '總收文號', mapping: function (node) {
                return {items: OA.common.Utils.getWKChildren(node, '總收文號')};
            }
            },
            {
                name: '受會單位', mapping: function (node) {
                return {items: OA.common.Utils.getWKChildren(node, '受會單位')};
            }
            },
            {
