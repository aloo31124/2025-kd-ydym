...
// 						|| elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
            ...
            var clickScroll = function() {
                if (toolButtonClick('#tool_scroll')) {
                    svgCanvas.setMode('scroll');
                }
            ...
            var doImportTest = function(){

                $.get('data/test_utf8_10.xml',function(data){
                    var xmlContent='';
                    //code for IE
                    ...
                    // code for Chrome, Safari, Firefox, Opera, etc.
                        ...
                        xmlContent = (new XMLSerializer()).serializeToString(data);
                    }


//                    alert(xmlContent);
                    svgCanvas.setSvgString(xmlContent);
//                    svgCanvas.clearSelection();
//                    hideSourceEditor();
//                    zoomImage();
//                    prepPaints();
...
// 				var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
            ...
            var Actions = function() {
                ...
                var tool_buttons = [
                    ...
                    {sel:'#tool_scroll', fn: clickScroll, evt: 'click', key: ['S', true]},
                    {sel:'#tool_source_test', fn: doImportTest, evt: 'click'},
