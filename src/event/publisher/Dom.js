...
Ext.define('Ext.event.publisher.Dom', {
    ...
    attachListener: function(eventName, doc) {
        ...
        // 20191106 rick 因應更新IOS13抓不到ipad及iphone,導致製作無法開啟
        // if (Ext.os.is.iOS && Ext.os.version.getMajor() < 5 || Ext.browser.is.AndroidStock) {
        if (/iPad|iPhone|iPod/.test(navigator.platform) || (navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1) || Ext.browser.is.AndroidStock) {
