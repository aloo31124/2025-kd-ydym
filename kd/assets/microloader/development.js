...
(function () {
    ...
    xhr.open('GET', root + 'app.json', false);
    xhr.send(null);
    ...
    for (i = 0, ln = styleSheets.length; i < ln; i++) {
        ...
        write('<link rel="stylesheet" href="' + root +path + '">');
    }
    ...
    for (i = 0, ln = scripts.length; i < ln; i++) {
        ...
        //modify jquery conflict
        var isJquery = path.indexOf('jquery.min.js') >= 0;
        if (isJquery && window.jQuery) {
            continue;
        }

        write('<script src="' + root + path + '"></' + 'script>');
    }
